...
describe('Testing the SnsBrokerAdapter', () => {
  ...
  describe('Testing also the Topic subscription', () => {
    ...
    it('correctly creates a consumer and sends an event when creating a Topic', async (done) => {
      const getPath = '/sns';
  ...
  describe('Without testing also the Topic subscription', () => {
    it('correctly creates a consumer and sends an event when not creating a Topic and providing the awsAccountId', async (done) => {
      const getPath = '/sns';
      const consumerUrl = `http://localhost:3050${getPath}`;
      const aggregate = 'user';
      const eventType = 'UserCreated';
    ...
    it('correctly creates a consumer and sends an event when not creating a Topic and without awsAccountId', async (done) => {
      const getPath = '/sns';
      const consumerUrl = `http://localhost:3050${getPath}`;
      const aggregate = 'user';
      const eventType = 'UserCreated';
